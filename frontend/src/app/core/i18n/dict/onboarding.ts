...
export const onboardingEs = {
  ...
  'onboarding.lo_que_no_marques': 'Lo que no marques no se usa: si no tienes horno, no te proponemos nada al horno. El resto del catálogo (ollas, herramientas, tus utensilios propios) lo dejas marcado en el inventario.',
...
export const onboardingEn: Record<keyof typeof onboardingEs, string> = {
  ...
  'onboarding.lo_que_no_marques': 'Whatever you leave unticked is not used: no oven, nothing with the oven. The rest of the catalogue (pots, tools, your own utensils) stays ticked in the inventory.',
